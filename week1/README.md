...
> 💡 这个 mini 版就是 [exercise/day3/mini_device_query.cu](exercise/day3/mini_device_query.cu)，你可以直接编译运行。
...
[exercise/day3/occupancy_verify.cu](exercise/day3/occupancy_verify.cu) 就是用来对比手算与 API 结果的验证程序。
...
参考上面的代码，编译运行 [exercise/day3/mini_device_query.cu](exercise/day3/mini_device_query.cu)：
...
完成 [exercise/day3/occupancy_problems.md](exercise/day3/occupancy_problems.md) 中的手算练习题，覆盖寄存器、共享内存、block size 等典型约束场景。
...
- [ ] 能自己写一个简化版 deviceQuery（[mini_device_query.cu](exercise/day3/mini_device_query.cu)）
- [ ] 理解自己 GPU 的硬件限制参数
- [ ] 能计算 GPU 的理论峰值算力
- [ ] 能计算 GPU 的理论显存带宽
