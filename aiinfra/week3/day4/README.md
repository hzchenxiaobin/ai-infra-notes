...
1. **标准 Attention 中 softmax 部分的 arithmetic intensity 是多少？是 compute-bound 还是 memory-bound？**
...
1. **标准 Attention 的 GEMM 部分是 compute-bound，为什么整体还是慢？**
...
1. **N 翻倍时，标准 Attention 的 HBM IO 变几倍？为什么？**
...
1. **为什么 FlashAttention 能把 IO 从 O(N²) 降到 O(Nd)？核心思想是什么？**
