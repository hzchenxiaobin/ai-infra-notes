...
1. **什么是向量化加载？为什么 float4 能让 memory-bound kernel 提速 2-4x？**
...
1. **Welford 算法是什么？为什么能减少 LayerNorm 的 HBM 读次数？**
...
1. **你看过哪些开源 kernel 实现？FasterTransformer LayerNorm 比 PyTorch ATen 多了哪些优化？**
