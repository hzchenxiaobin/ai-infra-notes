...
1. **为什么 Warp Shuffle 比 Shared Memory 更适合做 Warp 内归约？实际延迟差距有多大？**
...
1. **`__shfl_down_sync` 和 `__shfl_xor_sync` 在归约场景下有什么区别？**
