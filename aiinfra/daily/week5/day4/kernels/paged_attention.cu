...
__global__ void paged_attention_kernel(
    ...
    const float* __restrict__ q, float* __restrict__ output, int seq_len, int d, int max_blocks_per_seq) {
...
void attention_cpu(const float* K, const float* V, const float* q, float* out, int seq_len, int d) {
