...
![Mini AI Infra 系统架构图（分层视图）](../images/mini_engine_architecture.svg)
...
![请求生命周期数据流图](../images/request_lifecycle_dataflow.svg)
...
![Continuous Batching 时间线](../images/continuous_batching_timeline.svg)
