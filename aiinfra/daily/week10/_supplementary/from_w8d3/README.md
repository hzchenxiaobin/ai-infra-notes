...
创建文件 [kernels/full_scheduler.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week10/day7/kernels/full_scheduler.py)，实现支持六大功能的完整调度器：
...
完整代码见 [kernels/full_scheduler.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week10/day7/kernels/full_scheduler.py)。
...
#### 任务 5：LeetCode 面试题（10 周计划 · 第 8 周 Day 2）
