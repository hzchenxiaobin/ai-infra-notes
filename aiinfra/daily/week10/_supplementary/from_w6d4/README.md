...
nsys profile -o mini_engine_timeline --trace=cuda,nvtx \
 python aiinfra/daily/week10/day7/kernels/mini_engine_v0.py
...
创建文件 [kernels/profile_engine_v0.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week10/day7/kernels/profile_engine_v0.py)，对 Day 5 的 Mini 引擎做端到端 profiling：
...
ncu --kernel-name regex:addmm \
 ...
 dram__throughput.avg.pct_of_peak_sustained_elapsed, \
 sm__throughput.avg.pct_of_peak_sustained_elapsed \
 python aiinfra/week10/day7/kernels/profile_engine_v0.py
```
