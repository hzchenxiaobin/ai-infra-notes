...
创建文件 [kernels/concurrent_engine.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week10/day3/kernels/concurrent_engine.py)，实现三线程协作的并发推理引擎：
...
完整代码（含 5 个 demo）见 [kernels/concurrent_engine.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week10/day3/kernels/concurrent_engine.py)。
