...
- **能力地图**：40 项 checklist（10 周扩展后），标注 ✅/⚠️，汇总强项占比，待提升项即后续重点
...
| 时间 | 充足版（6h） | 紧凑版（3h） |
|------|------------|------------|
| 能力地图 | 2h：40 项逐项自评 + 强项/待提升深挖 | 45min：勾选 checklist + 标注 Top3 待提升 |
...
2. **能力地图 Checklist**：40 项逐项自评，33 项强项（面试底气）/ 7 项待提升（后续重点）
