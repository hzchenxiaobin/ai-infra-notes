...
| 项目结构 | 各周独立 | **统一目录树** |
| 架构图 | 无 | **一张图看懂系统**（细化见 [`_supplementary/from_w9d7/`](../_supplementary/from_w9d7/)） |

![10 周代码 → 一份可展示的项目文档](../images/doc_consolidation_lifecycle.svg)

> 💡 **一句话总结**：Day 3 的核心是把"代码堆"变成"项目"——用 README 回答面试官的五个高频问题（介绍项目 / 能跑吗 / 架构 / 成果 / 后续），让仓库自己会"说话"。
...
| **系统架构** | "画一下架构图" | 模块层次图（细化见 [`_supplementary/from_w9d7/`](../_supplementary/from_w9d7/)） |
...
Day 3 我们把 9 周散落的代码与笔记，打磨成一份面向面试的项目文档框架：
...
掌握这些后，你就有了项目的"门面"——系统架构图与数据流图的绘制属于补充专题，见 [`_supplementary/from_w9d7/`](../_supplementary/from_w9d7/)，让面试官一眼看懂 Mini 引擎的设计。
