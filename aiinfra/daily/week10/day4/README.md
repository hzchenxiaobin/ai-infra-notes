...
创建文件 [kernels/mock_interview.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week10/day4/kernels/mock_interview.py)，把 Mock 面试的 7 个环节做成一个带计时器的练习系统：
...
完整代码见 [kernels/mock_interview.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week10/day4/kernels/mock_interview.py)。
