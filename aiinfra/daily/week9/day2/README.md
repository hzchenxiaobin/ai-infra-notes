...
创建文件 [kernels/stability_test.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week9/day2/kernels/stability_test.py)，实现完整的系统联调测试套件：
...
完整代码见 [kernels/stability_test.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week9/day2/kernels/stability_test.py)。
