...
创建文件 [kernels/custom_ops_module.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week9/day1/kernels/custom_ops_module.py)，实现自定义 Kernel 的 PyTorch C++ Extension 集成：
...
完整代码见 [kernels/custom_ops_module.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week9/day1/kernels/custom_ops_module.py)。
