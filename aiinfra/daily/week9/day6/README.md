...
创建文件 [kernels/benchmark_demo.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week9/day6/kernels/benchmark_demo.py)，实现一个可复用的 kernel benchmark 框架（以 SiLU 为例），输出能直接贴进 README 的 Markdown 表格：
...
完整代码见 [kernels/benchmark_demo.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week9/day6/kernels/benchmark_demo.py)。
