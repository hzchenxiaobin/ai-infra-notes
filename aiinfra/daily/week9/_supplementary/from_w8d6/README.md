...
创建文件 [kernels/ring_attention_sim.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week10/day7/kernels/ring_attention_sim.py)，用 numpy 单机模拟 N=4 GPU 的 Ring Attention（无需真实多卡 / GPU）：
...
完整代码见 [kernels/ring_attention_sim.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week10/day7/kernels/ring_attention_sim.py)。
