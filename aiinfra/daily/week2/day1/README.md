...
![Warp Shuffle 四大家族数据流向](../images/warp_shuffle_primitives.svg)
...
![__shfl_down_sync 参数详解](../images/shfl_down_params.svg)
...
![Warp Reduce Butterfly 模式](../images/butterfly_reduction.svg)
...
![两级归约流程](../images/two_level_reduction.svg)
...
> 💡 提交后在 [LeetGPU Prefix Sum 题目](https://leetgpu.com/challenges/prefix-sum)上记录通过耗时，用 ncu 对比不同参数的性能差异。完整题解见 [Prefix Sum 题解](../../../../aiinfra/topics/cuda/medium/scan/prefix-sum.md)。
