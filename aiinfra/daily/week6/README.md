...
> 核心目标：掌握 PagedAttention、FlashDecoding、Mini 引擎 v0、量化推理（W8A16/INT8/FP8）、Dynamic Batching

| 项目　　　 | 说明　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　|
| ------------| --------------------------------------------------------------------------|
| 前置要求　 | 已完成 Week 5，掌握 FA-2、KV Cache、vLLM 架构　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　|
| 建议时长　 | 工作日每天 2.5h，周末每天 6h，周计 24.5h　　　　　　　　　　　　　　　　　　　|
| 本周产出　 | PagedAttention kernel、Mini 引擎 v0、量化 kernel（W8A16/INT8 KV/FP8）、Dynamic Batching 模拟器　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　|
| 周日里程碑 | Mini 引擎 v0 端到端可跑，量化 kernel 正确性 PASS，理解 PagedAttention block table 机制　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　|
...
| Day 6 | 推理系统核心问题总结 | [day6/](day6/README.md) |
| Day 7 | Dynamic Batching | [day7/](day7/README.md) |
