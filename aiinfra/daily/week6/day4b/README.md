## Day 4b：Chunked Prefill 与 Prefix Caching 实操
...
完整代码见 [kernels/prefix_cache_engine.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week6/day4b/kernels/prefix_cache_engine.py)。
