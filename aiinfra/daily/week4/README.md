...
> 核心目标：源码分析、C++ Extension 集成、Profiling、FA 论文精读与 Forward/Backward kernel、官方源码

| 项目　　　 | 说明　　　　　　　　　　　　　　　　　　　　　　　　　　　　　|
| ------------| ------------------------------------------------------------|
| 前置要求　 | 已完成 Week 3，掌握 Transformer 算子、Triton、Attention IO　　　　　　　　　　　　　　　　　　　　　　　|
| 建议时长　 | 工作日每天 2.5h，周末每天 6h，周计 24.5h　　　　　　　　　　|
| 本周产出　 | C++ Extension 集成代码、profiling 报告、FA Forward/Backward kernel、官方源码导读　　　　　　　　　　　　　　　　　　　　　　　　　|
| 周日里程碑 | 手写 FA Forward kernel 正确性 PASS，理解 online softmax 与 FA Backward 数据流　　　　　　　　　　　　　　　　　　　　　　　|
...
| Day | 主题 | 目录 |
|-----|------|------|
| Day 1 | 源码分析 —— PyTorch / FasterTransformer | [day1/](day1/README.md) |
| Day 2 | 算子接入 Mini 引擎（C++ Extension） | [day2/](day2/README.md) |
| Day 3 | 端到端 Profiling 与 Kernel Fusion | [day3/](day3/README.md) |
