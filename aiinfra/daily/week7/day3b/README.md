## Day 3b：分布式推理专题 —— TP/PP/DP 与通信计算重叠
...
创建文件 [kernels/tp_inference_demo.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week7/day3b/kernels/tp_inference_demo.py)，用 `torch.chunk` 在单卡上模拟 2-GPU TP 推理：
...
完整代码见 [kernels/tp_inference_demo.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week7/day3b/kernels/tp_inference_demo.py)。
...
创建文件 [kernels/comm_overlap_demo.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week7/day3b/kernels/comm_overlap_demo.py)，演示双 CUDA Stream 通信-计算重叠：
...
完整代码见 [kernels/comm_overlap_demo.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week7/day3b/kernels/comm_overlap_demo.py)。
