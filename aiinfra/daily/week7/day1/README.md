...
**题目链接**：[128. 最长连续序列](https://hzchenxiaobin.github.io/leetcode/problems/最长连续序列.html)
...
> 💡 完整题解（含 C++/Python 参考代码、哈希集合图解、与引擎 request_id 索引的类比）见 [最长连续序列题解](https://hzchenxiaobin.github.io/leetcode/problems/最长连续序列.html)。
