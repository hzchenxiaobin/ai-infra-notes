## Day 6b：CUDA Graph 实操 —— 消除 Kernel Launch Overhead
...
创建文件 [kernels/cuda_graph_capture.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week7/day6b/kernels/cuda_graph_capture.py)，用 `torch.cuda.CUDAGraph` 捕获 Mini Engine 的单步 decode（embedding + LayerNorm + QKV + attention + out_proj + sampling），对比 eager vs graph replay：
...
完整代码见 [kernels/cuda_graph_capture.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week7/day6b/kernels/cuda_graph_capture.py)。
...
创建文件 [kernels/shape_bucketing.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week7/day6b/kernels/shape_bucketing.py)，为动态 batch 预捕获多个 graph：
...
完整代码见 [kernels/shape_bucketing.py](https://github.com/hzchenxiaobin/ai-infra-notes/blob/main/aiinfra/daily/week7/day6b/kernels/shape_bucketing.py)。
