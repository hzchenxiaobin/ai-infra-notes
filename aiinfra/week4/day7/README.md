...
![标准 Attention vs FlashAttention IO 对比](../website/images/flash_attention_naive_vs_fused.svg)
...
将上文六大策略和决策树整理到 [notes/io_optimization_methodology.md](notes/io_optimization_methodology.md)，并补充至少一个 Transformer 外的应用例子：
