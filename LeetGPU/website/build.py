...
Uses absolute paths (/css/..., /js/...) for shared resources,
since LeetGPU/ is one level below the deployment root on GitHub Pages.
"""
...
def build_nav(current_slug: Optional[str], solutions: List[Dict]) -> str:
    ...
    lines.append(f'<a class="{overview_class}" href="/LeetGPU/index.html">📌 LeetGPU 题解</a>')
    lines.append('<div class="nav-section-title">题目</div>')
    for s in solutions:
        cls = "nav-link active" if current_slug == s["slug"] else "nav-link"
        lines.append(f'<a class="{cls}" href="/LeetGPU/{s["slug"]}.html">{s["title"]}</a>')
    ...
    <div class="site-container">
        <aside class="sidebar">
            <div class="sidebar-header">
                <a href="/LeetGPU/index.html" style="text-decoration: none;">
...
{nav_html}
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <a class="back-link" href="/LeetGPU/index.html">← 返回题解列表</a>
            </div>
            <article class="content" id="content"></article>
            <div class="day-nav-bottom"><a class="back-link" href="/LeetGPU/index.html">← 返回题解列表</a></div>
        </main>
    </div>
...
def build_website(leetgpu_dir: Path, output_dir: Path) -> None:
    ...
    for md_file in md_files:
        ...
        markdown_text = markdown_text.replace("](images/", "](/LeetGPU/images/")
    ...
    for s in solutions:
        cards_html += (
            f'<a class="day-card" href="/LeetGPU/{s["slug"]}.html">\n'
